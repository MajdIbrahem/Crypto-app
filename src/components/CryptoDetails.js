...
import HighLowIndecator from './HighLowIndecator';
...
const CryptoDetails = () => {
    ...
    return createPortal(
        <div onClick={close} className='fixed top-0 w-full h-full bg-gray-200 bg-opacity-30 first-letter: backdrop-blur-sm flex items-center justify-center font-nunito'>
            <div onClick={(e) => { e.stopPropagation() }} className='w-[65%] h-[90%] bg-gray-300 bg-opacity-75 rounded-lg relative text-white'>
                {coinData ?
                    <div className='flex items-center md:flex-row flex-col justify-center w-full h-full p-4 '>
                        <div className='md:flex hidden flex-col w-[45%] h-full pr-2'>
                            <div className='flex items-center w-full '>
                                <img className='w-[3rem] h-[3rem] mx-1.5' src={coinData.image.large} alt=''></img>
                                <h1 className='text-xl capitalize font-medium'>{coinData.name}</h1>
                                <span className='text-sm py-0.5 px-2.5 ml-2 bg-cyan bg-opacity-25 text-cyan rounded uppercase'>{coinData.symbol}</span>
                            </div>
                            <div className='flex w-full mt-6'>
                                <div className='flex flex-col w-full'>
                                    <div className='flex justify-between'>
                                        ...
                                        ${Number(coinData.market_data.price_change_percentage_24h).toFixed(2) >0 ?'bg-green text-green' :'bg-red text-red'}`} >
                                            <span>{Number(coinData.market_data.price_change_percentage_24h).toFixed(2)}%</span>
                                            <svg width="14" height="14" viewBox="0 0 14 14"
                                                xmlns="http://www.w3.org/2000/svg"
                                                className={`width-[1rem] ml-0.5 ${Number(coinData.market_data.price_change_percentage_24h).toFixed(2) >0 ?'fill-green rotate-180' :'fill-red'}`}
                                            >
                                    ...
                                    <h2 className='text-lg font-bold'>{new Intl.NumberFormat("en-IN", {
                                            ...
                                            }).format(coinData.market_data.current_price[currency])}</h2>
                                </div>
                            </div>
                            <div className='flex justify-between mt-4 w-full'>
                                ...
                                <div className='flex flex-col'>
                                    <span className='text-sm capitalize text-gray-100'>diluted valuation</span>
                                    <h2 className='text-base font-bold'>{new Intl.NumberFormat("en-IN", {
                                        style: 'currency', currency: currency,
                                        notation:"compact"
                            ...
                            <div className='flex justify-between w-full mt-4'>
                                <HighLowIndecator currentPrice={coinData.market_data.current_price[currency]} high={coinData.market_data.high_24h} low={coinData.market_data.low_24h}></HighLowIndecator>
                            </div>
                            <div className='flex justify-between mt-4 w-full'>
                                <div className='flex flex-col'>
                            ...
                            <div className='md:flex hidden justify-between mt-4 w-full '>
                                <div className='flex flex-col '>
                                    ...
                                    {coinData.links.official_forum_url &&  <a target={"_blank"} rel="noreferrer"  className='text-sm bg-gray-200 text-gray-100 px-1.5 py-0.5 my-1 rounded' href={coinData?.links?.official_forum_url[0]}>{coinData.links.official_forum_url[0].substring(0,30)}</a>}
                                </div>
                                <div className='flex flex-col content-start'>
                                    ...
                                    <div className='flex justify-between'>
                                        ...
                                        <div className={`text-sm px-1 ml-2 my-1 font-medium flex items-center rounded uppercase bg-opacity-25 bg-green text-green'}`} >
                                            ...
                                            <svg width="14" height="14" viewBox="0 0 14 14"
                                                xmlns="http://www.w3.org/2000/svg"
                                                className={`width-[1rem] ml-0.5  fill-green rotate-180`}
                                            >
                                            <path d="M7.47951 11.4153C7.42599 11.493 7.35438 11.5565 7.27085 11.6004C7.18732 11.6444 7.09437 11.6673 7.00001 11.6673C6.90564 11.6673 6.81269 11.6444 6.72916 11.6004C6.64563 11.5565 6.57402 11.493 6.52051 11.4153L1.27051 3.83194C1.20974 3.74447 1.1741 3.64202 1.16747 3.53572C1.16084 3.42943 1.18346 3.32334 1.23289 3.229C1.28232 3.13466 1.35665 3.05567 1.44782 3.0006C1.53899 2.94554 1.6435 2.91652 1.75001 2.91669H12.25C12.3563 2.91713 12.4604 2.94652 12.5512 3.00172C12.642 3.05691 12.716 3.13581 12.7653 3.22993C12.8147 3.32406 12.8374 3.42984 12.8311 3.53591C12.8247 3.64199 12.7896 3.74433 12.7295 3.83194L7.47951 11.4153Z"/>
                                            </svg>
                                    ...
                                    <div className='flex justify-between'>
                                        ...
                                        <div className={`text-sm px-1 ml-2 my-1 font-medium flex items-center rounded uppercase bg-opacity-25 'bg-red text-red`} >
                                            ...
                                            <svg width="14" height="14" viewBox="0 0 14 14"
                                                xmlns="http://www.w3.org/2000/svg"
                                                className={`width-[1rem] ml-0.5 fill-red`}
                                            >
                                            <path d="M7.47951 11.4153C7.42599 11.493 7.35438 11.5565 7.27085 11.6004C7.18732 11.6444 7.09437 11.6673 7.00001 11.6673C6.90564 11.6673 6.81269 11.6444 6.72916 11.6004C6.64563 11.5565 6.57402 11.493 6.52051 11.4153L1.27051 3.83194C1.20974 3.74447 1.1741 3.64202 1.16747 3.53572C1.16084 3.42943 1.18346 3.32334 1.23289 3.229C1.28232 3.13466 1.35665 3.05567 1.44782 3.0006C1.53899 2.94554 1.6435 2.91652 1.75001 2.91669H12.25C12.3563 2.91713 12.4604 2.94652 12.5512 3.00172C12.642 3.05691 12.716 3.13581 12.7653 3.22993C12.8147 3.32406 12.8374 3.42984 12.8311 3.53591C12.8247 3.64199 12.7896 3.74433 12.7295 3.83194L7.47951 11.4153Z"/>
                                            </svg>
                        ...
                        <div className='flex flex-col md:w-[55%] w-[100%] h-full pl-3'>
                            <Chart id={coinData.id}></Chart>
                            <div className='flex flex-col mt-32'>
                                ...
                                <h3 className='text-white py-1'> <span className='text-gray-100 capitalize mr-1'>coin rank : </span>{coinData.coingecko_rank} </h3>
                                <h3 className='text-white py-1'> <span className='text-gray-100 capitalize mr-1'>coin score : </span>{coinData.coingecko_score} </h3>
                            </div>
                            <div className='absolute bottom-8 right-8 flex items-center'>
                                {coinData.links.repos_url.github[0] && <a className='text-lg px-1' target={"_blank"} rel="noreferrer" href={coinData.links.repos_url.github[0]}>
                                <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    ...
    >
        ...
        <path fill="rgba(0, 0, 0, 0)" d="M0 0h24v24H0z" />
                                ...
                                {coinData.links.twitter_screen_name && <a className='text-lg px-1' target={"_blank"} rel="noreferrer" href={`https://twitter.com/${coinData.links.twitter_screen_name}`}>
                                <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
  ...
  >
    ...
    <path fill="rgba(0, 0, 0, 0)" d="M0 0h1024v1024H0z" />
                                ...
                                {coinData.links.facebook_username && <a className='text-lg px-1' target={"_blank"} rel="noreferrer" href={`https://facebook.com/${coinData.links.facebook_username}`}>
                                <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
  ...
  >
    ...
    <path fill="rgba(0, 0, 0, 0)" d="M0 0h24v24H0z" />
                                ...
                                {coinData.links.subreddit_url && <a className='text-lg px-1' target={"_blank"} rel="noreferrer" href={coinData.links.subreddit_url}><svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    style={{
